 ...
 * @version 1.0
 */
public final class ASN1NullCoder implements PrimitiveDecoder, PrimitiveEncoder {

	@SuppressWarnings({"UnusedDeclaration"})
	private final static Logger logger = Logger.getLogger(ASN1NullCoder.class);
