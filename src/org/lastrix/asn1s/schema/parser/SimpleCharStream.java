...
public class SimpleCharStream {
	...
	static protected void FillBuff() throws java.io.IOException {
		if (maxNextCharInd == available) {
			...
			} else if (available > tokenBegin) { available = bufsize; } else if ((tokenBegin - available) < 2048) { ExpandBuff(true); } else {
				available = tokenBegin;
			}
		}
	...
	static public String GetImage() {
		if (bufpos >= tokenBegin) { return new String(buffer, tokenBegin, bufpos - tokenBegin + 1); } else {
...
/* JavaCC - OriginalChecksum=90cc885bf2dbd7adef92b07a7ad5200e (do not edit this line) */
